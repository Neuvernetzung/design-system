            ...
            rightAddon={{
              ...
              children: (
                <ButtonGroup
                  ...
                  className={cn("w-full h-full justify-stretch items-stretch")}
                >
                  <Button
                    variant="ghost"
                    onClick={() => {
...
export const InputNumber = forwardRef(InputNumberInner) as <
...
) => ReturnType<typeof InputNumberInner>;
