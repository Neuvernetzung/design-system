...
>(
  {
    ...
    required,
    ...props
  }: SelectMultipleProps & UseControllerProps<TFieldValues, TName>,
...
export type SelectMultipleRawProps = SelectMultipleProps & {
  id: string;
  value?: string[];
  defaultValue?: string[];
...
export const SelectMultipleRaw = forwardRef(
  (
    {
      id,
      options,
...
SelectMultipleRaw.displayName = "SelectMultipleRaw";
